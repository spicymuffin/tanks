...
public class Client
{
    ...
    public class TCP
    {
        ...
        public void Connect(TcpClient _socket)
        {
            ...
            ServerSend.Welcome(id, "server reply");
        }
    ...
    public void SendIntoGame(Vector3 _position)
    {
        player = NetworkManager.instance.InstantiatePlayer(_position);
        player.Initialize(id, username);
    }

    public void SetUsername(string _playerName)
    {
